...
//====================================
function InsertChart( $flash_file, $library_path, $php_source, $width=400, $height=250, $bg_color="ffffff", $transparent=true, $license=null ){
	
	$php_source=urlencode($php_source);
	$library_path=urlencode($library_path);
	$protocol = (strtolower($_SERVER['HTTPS']) != 'on')? 'http': 'https';

	$html="<div style=\"z-index=-1\"><OBJECT classid='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000' codebase='".$protocol."://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0' ";
	...
	$html.="TYPE='application/x-shockwave-flash' PLUGINSPAGE='".$protocol."://www.macromedia.com/go/getflashplayer'></EMBED></OBJECT></div>";
	return $html;
